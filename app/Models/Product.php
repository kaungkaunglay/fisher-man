...
{
    use HasFactory;
    protected $fillable = ['name', 'product_price', 'product_image', 'stock', 'weight', 'size', 'day_of_caught', 'expiration_date', 'discount','is_time_sale', 'sub_category_id','description','user_id','status'];
