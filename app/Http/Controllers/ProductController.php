...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'product_price.integer' => '小数点以下は入力できません',
            ...
            'discount.integer' => '小数点以下は入力できません',
        ...
        $request->validate([
            ...
            'product_price' => 'required|integer|min:1|max:99999999.99', // Ensure price is greater than 0
            'product_image' => 'required|image|mimes:png,jpg,jpeg|max:1024',
            'stock' => 'required|integer',
            'weight' => 'required|min:1', // Ensure weight is greater than 0
            'size' => 'required|numeric|min:1|max:999999',
            'day_of_caught' => ['required','date',new ValidDayOfCaught()],
            'expiration_date' => ['required','date',new ValidExpireDate()],
            'discount' => 'nullable|integer|min:0|max:' . ($request->product_price ?? 0), // Ensure discount is not greater than price
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $messages = [
            ...
            'product_image.max' => '商品画像は1024KB以下でなければなりません',
            'stock.integer' => '小数点以下は入力できません',
            'weight.numeric' => '重量は数値でなければなりません',
            'weight.min' => '重量は0より大きい数字でなくてはなりません',
            'size.required' => '長さのフィールドは必須です',
            'size.numrice' => '重量は数値でなければなりません',
            'size.min' => 'サイズは1文字以上でなければなりません',
    ...
    $request->validate([
        ...
        'product_price' => 'sometimes|integer|min:1|max:99999999.99',
