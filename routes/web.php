...
Route::post('/profile/user/update_basic', [ProfileController::class, 'update_basic_profile'])->name('update_basic_profile');
    Route::post('/profile/user/update_contact', [ProfileController::class, 'update_contact_details'])->name('update_contact_details');
