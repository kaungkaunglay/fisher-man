...
//products-sorting
Route::get('/products/srot/',[ProductController::class,'sortBy'])->name('products.sort');
...
Route::middleware(['is_seller'])->group(function () {
    ...
    Route::post('/profile/seller/update_contact', [ProfileController::class, 'update_contact_details'])->name('seller.update_contact_details');
     ...
     Route::get('/admin/products/time-sale', [ProductController::class, 'timeSaleProducts'])->name('admin.products.time_sale');
...
Route::put('/profile/update_info', [ProfileController::class, 'update_info'])->name('update_info');
Route::put('/profile/update_contact', [ProfileController::class, 'update_contact'])->name('update_contact');
