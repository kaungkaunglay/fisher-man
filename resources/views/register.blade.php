            ...
            <div class="row ph-no">
                <div class="input-box col-md-6 col-xs-12 d-flex flex-column">
                    ...
                    <div class="input-group">
                        ...
                        <input maxlength="10" id="first_phone" name="first_phone" placeholder="00-0000-0000" type="number"
                ...
                <div class="input-box col-md-6 col-xs-12 d-flex flex-column">
                    ...
                    <div class="input-group">
                        ...
                        <input maxlength="10" id="second_phone" name="second_phone" placeholder="00-0000-0000" type="number"
                            class="form-control bg-second" autocomplete="off">
                    </div>
                    <span class="invalid-feedback"></span>
                </div>
