  ...
  <div class="container">
    <div class="card verification-card">
      ...
      <div class="card-body text-center py-5">
        ...
        <p class="card-text mb-3 pop-in" style="animation-delay: 0.4s;">Your email has been successfully verified.</p>
        <p class="text-muted mb-4 fade-in">You can now enjoy all the features of your account.</p>
        <a href="#" class="btn btn-primary px-4 py-2 fade-in" style="animation-delay: 0.8s;">Continue to Dashboard</a>
      </div>
