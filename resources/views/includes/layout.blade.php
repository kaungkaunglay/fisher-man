  ...
  <script src="{{asset('assets/js/preloader.js')}}"></script> --}}
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Select all elements with the class name 'format'
            document.querySelectorAll('.format').forEach(function(element) {
                // Get the raw price value from the element's text content
                let rawPrice = element.textContent.replace('¥', '').replace(/,/g, '');

                // Format the price using the formatPriceJapanese function
