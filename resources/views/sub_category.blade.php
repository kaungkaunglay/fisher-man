...
@section('contents')
    ...
    <section class="hero container-custom">
        ...
        <nav aria-label="breadcrumb" class="py-4">
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{ route('category', $subCategory->category_id) }}">{{ $subCategory->category->category_name }}</a>
                </li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('sub-category.show', ['id' => $subCategory->id, 'sort_by' => 'price_asc']) }}">{{ trans_lang('price_l_h') }}</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('sub-category.show', ['id' => $subCategory->id, 'sort_by' => 'price_desc']) }}">{{ trans_lang('price_h_l') }}</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('sub-category.show', ['id' => $subCategory->id, 'sort_by' => 'name_asc']) }}">{{ trans_lang('name_a_z') }}</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('sub-category.show', ['id' => $subCategory->id, 'sort_by' => 'name_desc']) }}">{{ trans_lang('name_z_a') }}</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('sub-category.show', ['id' => $subCategory->id, 'sort_by' => 'latest']) }}">{{ trans_lang('latest') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <form action="{{ route('sub-category.show', $subCategory->id) }}" method="GET" id="priceRangeForm">
                <div class="range-slider mx-auto">
                    ...
                    <div class="range-container position-relative mt-3 w-100">
                        ...
                        <input type="range" min="1" max="50000" value="{{ request('min_price', 1) }}"
                            id="slider-1">
                        <input type="range" min="1" max="50000" value="{{ request('max_price', 10000) }}"
                            id="slider-2">
                    </div>
                </div>
            </form>
