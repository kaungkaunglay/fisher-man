            ...
            <div class="sort-container">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="">{{ trans_lang('latest') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            @foreach ($products as $product)
                @if ($product->status == 'approved')
                    <div class="item-card mb-2">
                        ...
                        <div class="left pt-3">
                            <p class="price">
                                <!-- filepath: /c:/fisherman-project/laravel/fisher-man/resources/views/product-search-results.blade.php -->
                                @if ($product->discount > 0)
                                    <span
                                        class="format me-2">¥{{ number_format($product->product_price - $product->discount, 0) }}</span>
                                    <span
                                        class="original-price format">¥{{ number_format($product->product_price, 0) }}</span>
                                @else
                            ...
                            <div class="d-flex gap-2 card-btn m-t-10">
                                ...
                                <a href="javascript:void(0);" class="py-1 common-btn2 white-list-btn position-relative"
                                    data-id="{{ $product->id }}">
