...
@section('contents')
    ...
    <div class="row">
        <div class="col-md-3 text-center text-md-start">
            <img src="/api/placeholder/120/120" class="rounded-circle shop-avatar" alt="Shop avatar">
            <div class="mt-3">
        ...
        <div class="col-md-9 mt-4 mt-md-0">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="tab-content p-3" id="shopTabsContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel">
                            ...
                            <p>Artisan Crafts specializes in handmade products created by local artisans using traditional techniques and sustainable materials. Each item is unique and tells a story of craftsmanship passed down through generations.</p>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><i class="fas fa-certificate me-2 text-primary"></i> Certified Organic Materials</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h5>Shop Stats</h5>
                ...
                <div class="accordion mt-3" id="policyAccordion">
                    ...
                    <div id="collapseShipping" class="accordion-collapse collapse show" data-bs-parent="#policyAccordion">
                        ...
                        <p>We ship all items with tracking and insurance. International buyers are responsible for any customs fees that may apply.</p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div id="collapseReturns" class="accordion-collapse collapse" data-bs-parent="#policyAccordion">
                        <div class="accordion-body">
                        <p>We accept returns and exchanges within 30 days of delivery for items in original condition.</p>
                        ...
                        <p><strong>Non-returnable items:</strong> Custom orders, personalized items, and sale items marked as final sale.</p>
