...
<!-- Mirrored from themesflat.co/html/remos/product-detail-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Jan 2025 01:49:54 GMT -->
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clip-path="url(#clip0_604_18468)">
                            <path
                              ...
                              stroke="#111111" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                              stroke-linejoin="round" />
                            <path d="M19.0015 4.44801H15.5586V1L19.0015 4.44801Z" stroke="#111111" stroke-width="1.2"
              ...
              <div class="header-left">
                <a href="index.html">
                  <img class="" id="logo_header_mobile" alt="" src="images/logo/logo.png"
                    data-light="images/logo/logo.png" data-dark="{{asset('assets/images/logo.png')}}" data-width="154px"
                      ...
                      <li>
                        <div class="message-item item-1">
                          ...
                          <div>
                            ...
                            <div class="text-tiny">Morbi sapien massa, ultricies at rhoncus at, ullamcorper nec diam
                            </div>
                          </div>
                        </div>
                      </li>
                      ...
                      <div class="thumbs-slider">
                        ...
                        <div class="swiper tf-product-media-main" id="gallery-swiper-started">
                          <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class="item">
                                <a href="images/products/product-detail-1.png" target="_blank" data-pswp-width="506px"
                                  data-pswp-height="810px">
                                  <img class="tf-image-zoom" data-zoom="images/products/product-detail-1.png"
                                    src="images/products/product-detail-1.png" alt="">
                                </a>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="item">
                                <a href="images/products/product-detail-2.png" target="_blank" data-pswp-width="500px"
                                  data-pswp-height="500px">
                                  <img class="tf-image-zoom" data-zoom="images/products/product-detail-2.png"
                                    src="images/products/product-detail-2.png" alt="">
                                </a>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="item">
                                <a href="images/products/product-detail-3.png" target="_blank" data-pswp-width="500px"
                                  data-pswp-height="500px">
                                  <img class="tf-image-zoom" data-zoom="images/products/product-detail-3.png"
                                    src="images/products/product-detail-3.png" alt="">
                                </a>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="item">
                                <a href="images/products/product-detail-4.png" target="_blank" data-pswp-width="500px"
                                  data-pswp-height="500px">
                                  <img class="tf-image-zoom" data-zoom="images/products/product-detail-4.png"
                                    src="images/products/product-detail-4.png" alt="">
                                </a>
                              </div>
                            </div>
                            <div class="swiper-slide">
                              <div class="item">
                                <a href="images/products/product-detail-5.png" target="_blank" data-pswp-width="500px"
                                  data-pswp-height="500px">
                                  <img class="tf-image-zoom" data-zoom="images/products/product-detail-5.png"
                                    src="images/products/product-detail-5.png" alt="">
                                </a>
                              </div>
                            </div>
                          </div>
...
<!-- Mirrored from themesflat.co/html/remos/product-detail-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Jan 2025 01:50:04 GMT -->
